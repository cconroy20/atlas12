...
C
     ...
     &TYPE='OLD',FORM='UNFORMATTED',READONLY,SHARED)
      READ(10)
...
C     1(1.-FSCAT(J))+AXLINE(J)*SXLINE(J))/ALINE(J)
  ...
  241 continue 
c  241 SIGMAL(J)=ASYNTH(J)*FSCAT(J)
      CALL JOSH(1,IFSURF)
...
c     write(6,666)WL,GFLOG,XJ,E,XJP,EP,CODE,LABEL,LABELP,
c    1WL,NELION,GR,GS,GW,REF,NBLO,NBUP,ISO1,X1,ISO2,X2,OTHER1,OTHER2,
c    2DWL,DGFLOG,DGAMMAR,DGAMMAS,DGAMMAW,WL
c 666 FORMAT(F10.4,F7.3,F5.1,F12.3,F5.1,F12.3,F9.2,A8,A2,A8,A2/
c    1 0PF10.4,I4,F6.2,F6.2,F6.2,A4,I2,I2,I3,F7.3,I3,F7.3,
c    2A8,A2,A8,A2,F7.4,F7.3,3F6.2,F10.4)
      WAVE=WLVAC
...
c      IF(WL.GT.0.)WRITE(17,98)WL,GFLOG,XJ,E,XJP,EP,CODE,LABEL,LABELP,
...
c      IF(WL.LT.0.)WRITE(17,98)WL,GFLOG,XJ,E,XJP,EP,CODE,LABEL,LABELP,
      IF(WL.LT.0.)WRITE(16,98)WL,GFLOG,XJ,E,XJP,EP,CODE,LABEL,LABELP,
     1WL,NELION,GR,GS,GW,REF,NBLO,NBUP,ISO1,X1,ISO2,X2,OTHER1,OTHER2,
