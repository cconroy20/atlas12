...
| `quad=0\|1`  | 0           | `INTEG` quadrature for τ scales, P_rad, and height integrals: 0=legacy blended-parabola (PARCOE), 1=Steffen monotone cubic (3–6× more accurate on opacity-like integrands; experimental pending full-regime A/B) |
