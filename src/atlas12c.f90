...
PROGRAM ATLAS12
  ...
  DO I = 1, NARGS
    ...
    BLOCK
      ...
      CASE ('cnv_gap_hr'); READ(val, *, IOSTAT=ISTAT) CNV_GAP_HR_MIN
...
CONTAINS
  ...
  SUBROUTINE print_usage()
    ...
    WRITE(6, '(A)') '  cnv_gap_hr=X Rejected gap gate on bounding-layer F_conv fraction'
    WRITE(6, '(A)') '               (default 0 = inert; retained for A/B work only)'
